                ...
                children: [
                  ...
                  Expanded(
                    child: model.showSpinner
                        ? const _PrivateProfileDetailShimmer()
                        : model.showError
                        ? Padding(
                            padding: context.padSym(h: 20),
                            child: Center(
...
/// Mirrors public-profile mobile loading (avatar + stats + sports placeholders).
class _PrivateProfileDetailShimmer extends StatelessWidget {
  const _PrivateProfileDetailShimmer();
