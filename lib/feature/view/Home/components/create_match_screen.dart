  ...
  Widget build(BuildContext context) {
    ...
    final formBody = Column(
      ...
      children: [
        ...
        Selector<CreateMatchViewModel, (String?, List<String>, bool)>(
          selector: (_, m) =>
              (m.selectedSkillLevel, m.skillLevels, m.optionsLoading),
          builder: (context, state, _) {
                  ...
                  builder: (context, isEditMode, _) {
                    return Column(
                      ...
                      children: [
                        AppBarWidget(
                          showBackButton: true,
                          onTapFirst: () => Navigator.maybePop(context),
                              ...
                              children: [
                                ...
                                TextFormFieldWidget(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (!context.mounted) return;
                                    if (selectedLocation
                                            is LocationSelectionResult &&
                                        selectedLocation.location
                                            .trim()
                                            .isNotEmpty) {
                                      model.setSelectedLocation(
                                        selectedLocation,
                                      );
                                    } else if (selectedLocation is String &&
                                        selectedLocation.trim().isNotEmpty) {
                                ...
                                TextFormFieldWidget(
                                  ...
                                  onTap: () =>
                                      _showDurationPicker(context, model),
                                ),
                                SizedBox(height: context.h(10)),
                                Selector<CreateMatchViewModel, int>(
                                  selector: (_, m) => m.maxPlayers,
